    ...
    loop {
        ...
        if ip_camera_result.is_err() || motion_detection_result.is_err() {
            ...
            loop {
                ...
                if motion_event && (locked_motion_check_time.is_none() || locked_motion_check_time.unwrap().le(&current_time)) {
                ...
                if any_ack || (locked_delivery_check_time.is_none() || locked_delivery_check_time.unwrap().le(&current_time)) {
